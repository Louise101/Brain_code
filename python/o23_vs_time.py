...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  8 14:22:29 2023
...
fd = open('1o23_code14.dat', 'rb')
datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
fd.close()
s01_13=datain#np.flip(datain)

fd = open('30o23_code14.dat', 'rb')
datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
fd.close()
s030_13=datain#np.flip(datain)

fd = open('60o23_code14.dat', 'rb')
datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
fd.close()
s060_13=datain#np.flip(datain)

fd = open('120o23_code14.dat', 'rb')
datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
fd.close()
s0120_13=datain#np.flip(datain)

fd = open('180o23_code14.dat', 'rb')
datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
fd.close()
s0180_13=datain#np.flip(datain)

fd = open('240o23_code14.dat', 'rb')
datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
fd.close()
s0240_13=datain#np.flip(datain)

fd = open('300o23_code14.dat', 'rb')
datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
fd.close()
s0300_13=datain#np.flip(datain)

fd = open('420o23_code14.dat', 'rb')
datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
fd.close()
s0420_13=datain#np.flip(datain)

fd = open('480o23_code14.dat', 'rb')
datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
fd.close()
s0480_13=datain#np.flip(datain)

#fd = open('540o23_code13.dat', 'rb')
#datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
#fd.close()
#s0540_13=datain#np.flip(datain)

#fd = open('600o23_code13.dat', 'rb')
#datain=np.fromfile(file=fd, dtype=np.double).reshape(156,231,250)
#fd.close()
...
plt.savefig('o231noox.png',format='png',dpi=1200, bbox_inches='tight')
plt.show()
...
plt.ylabel('Concentration (uM)')  
plt.title('o23')
plt.savefig('o232noox.png',format='png',dpi=1200, bbox_inches='tight')
plt.show()